    ...
    <div className={styles.overlay}>
      <form className={styles.modal} onSubmit={handleSubmit}>
        ...
        <div className={styles.footer}>
          <button type="button" className={styles.limpiarBtn} onClick={handleLimpiar}>Limpiar</button>
          
          <button type="button" className={styles.recalcularBtn} onClick={handleRecalcular}>Recalcular</button>
