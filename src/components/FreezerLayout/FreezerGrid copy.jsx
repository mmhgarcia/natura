    ...
    return (
        <div style={containerStyle}>
            <div style={headerStyle}>
                <h3 style={{ textAlign: 'center', color: '#0080FF', margin: 0 }}>Distribución del Freezer</h3>
                <button
                    style={addBtnStyle}
            ...
            {containers.map(container => (
                <div key={container.id} style={{ marginBottom: '20px' }}>
            ...
            {isEditing && (
                <div style={editorStyle}>
                    <h4 style={{ margin: '0 0 15px 0' }}>Editar Sección</h4>
